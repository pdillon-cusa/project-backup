...
$.validator.addMethod("validYearEntered",
	    function(value, element) {
			var dateArray = value.split('/');
			if(dateArray.length == 3){
				var yearPart = dateArray[2];
				if(yearPart.indexOf("0") == 0 || yearPart.length != 4){
					return false;
				}else return true;
			}else return false;
	    },
	    "Year needs to be valid and 4 digits"
	);
...
$.validator.addMethod("passwordFormat", 
	...
	}, "Please Enter Valid Password. Minimum Length is 8. Use Alphabets, Numerals, @ ! # $ % * - . _ ~"
);
