...
7.) Support Functionality by Ryan Hollingsworth
...
$(document).ready(function() {
    ...
    $('[data-toggle="serialnumber"], .close-serial-number').click(function () {
    ...
    $(function () {
        ...
        $('html').click(function (e) {
            if ($('.megamenu').is(':visible') && !$(e.target).hasClass('toggleize') && $(e.target).parents('.megamenu').length <= 0) {
	...
	$(document).delegate('.contact-email .addBtn','click',function(e){  
	
		e.preventDefault();
		
		if (phoneCount == phoneMax-1){
			phoneCount++;
			var original = "<div class='row'><div id='Phone-"+phoneCount+"' class='product'><div class='form-group col-xs-12 col-sm-5'> <label for='phonetype-"+phoneCount+"'>Phone Type *</label> <select id='phonetype-"+phoneCount+"' class='form-control selectpicker'><option></option><option value=''>Mobile</option><option value=''>Office</option><option value=''>Home</option><option value=''>Other</option> </select></div><div class='form-group col-xs-10 col-sm-5 padding-phone'> <label>Phone Number <i class='fa fa-info-circle' data-toggle='popover' data-placement='top' data-content='Should the need arise, we may need to reach you by phone regarding the repair of your Canon product.' data-original-title='Why does Canon need my phone number?'></i> *</label> <input type='text' class='form-control' id='phone-"+phoneCount+"'></div><div class='col-xs-1 register-icon'> <a class='removeBtn' id='removePhone-"+phoneCount+"'> <span class='glyphicon glyphicon-minus-sign'></span> </a></div><div class='col-xs-1 register-icon'> <a class='addBtn hidden'> <span class='glyphicon glyphicon-plus-sign'></span> </a></div></div></div>";  
						    
								    
			$(this).closest('.row').append(original);			
			$(this).addClass('hidden');
			$('.selectpicker').selectpicker();
		}
		
		else if (phoneCount < phoneMax){
			phoneCount++;
		
			var original = "<div class='row'><div id='Phone-"+phoneCount+"' class='product'><div class='form-group col-xs-12 col-sm-5'> <label for='phonetype-"+phoneCount+"'>Phone Type *</label> <select id='phonetype-"+phoneCount+"' class='form-control selectpicker'><option></option><option value=''>Mobile</option><option value=''>Office</option><option value=''>Home</option><option value=''>Other</option> </select></div><div class='form-group col-xs-10 col-sm-5 padding-phone'> <label>Phone Number <i class='fa fa-info-circle' data-toggle='popover' data-placement='top' data-content='Should the need arise, we may need to reach you by phone regarding the repair of your Canon product.' data-original-title='Why does Canon need my phone number?'></i> *</label> <input type='text' class='form-control' id='phone-"+phoneCount+"'></div><div class='col-xs-1 register-icon'> <a class='removeBtn' id='removePhone-"+phoneCount+"'> <span class='glyphicon glyphicon-minus-sign'></span> </a></div><div class='col-xs-1 register-icon'> <a class='addBtn'> <span class='glyphicon glyphicon-plus-sign'></span> </a></div></div></div>";  
	...
	$(document).delegate('.contact-email .removeBtn','click',function(e){  
		var product = $(this).closest('.product');	
		var productID = product.attr('id');
		
		productNum = productID.replace(/\D/g,'');
		...
		$('.addBtn:last').removeClass('hidden');
    ...
    $('.img-transparent').each(function() {
        $(this).find('span').height($(this).parent('.row').height());
    });
	...
	$('.list-view').click(function(e) {
    	...
    	$('.product-listing .row').addClass('v-center-sm');
    	$('.product-list-image').addClass('col-sm-2');
    	$('.product-info-title').addClass('col-sm-3');
    	$('.product-rating').addClass('col-sm-2');
    	$('.product-price').addClass('col-sm-2');
    	$('.product-buttons').addClass('col-sm-3');
    ...
    $('.grid-view').click(function(e) {
    	...
    	$('.product-listing .row').removeClass('v-center-sm');
    	$('.product-list-image').removeClass('col-sm-2');
    	$('.product-info-title').removeClass('col-sm-3');
    	$('.product-rating').removeClass('col-sm-2');
    	$('.product-price').removeClass('col-sm-2');
    	$('.product-buttons').removeClass('col-sm-3');
    ...
    if (typeof google === 'object' && typeof google.maps === 'object') {
		...
		function ShowPins(address, icon) {
			var image;
			var activeAnimation;
		...
		function CreateMarkers(){
		  ...
		  $.each( carouselData.find('.item'), function(){
			  ...
			  if ($(this).hasClass('active')){
				   ShowPins( $(this).attr('data-address'),'active');
			  }else{
				 ShowPins( $(this).attr('data-address'),""); 
			  }
    ...
    // $(':password').pwstrength({
    //     ui: { showVerdictsInsideProgressBar: true, minChar:3 }
    // });
    // $('[data-toggle="popover"]').popover();
